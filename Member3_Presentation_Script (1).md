...
Hi everyone, I'm Salam, and I'm Member 3 on this team. My part of the project was applying mitigations against the issues, bugs, and flaws we identified in our Secure Task Management System — basically, taking each weakness we found and showing how we fixed it.
...
*(Demo: type a classic injection string like `' OR 1=1` into a task field and show it's stored as plain text, not executed.)*
...
Going forward, the team has identified further hardening, like adding two-factor authentication, as a future enhancement. That wraps up the mitigation side from my end — back to my teammate's part.
